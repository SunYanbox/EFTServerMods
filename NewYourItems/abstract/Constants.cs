...
{
    // 稀有度中文->键字典
    public static readonly Dictionary<string, string> RarityMapping = new Dictionary<string, string>
    {
        { "普通", "Common" },
        { "稀有", "Rare" },
        { "超级稀有", "Superrare" },
    ...
    {
        "Common", "Rare", "Superrare", "Not_exist"
    };
    ...
    public static string? GetRarityKey(string key)
    {
        ...
        if (RarityMapping.TryGetValue(key, out var rarityKey)) return rarityKey;
        return null;
    }
}
...
//     /// 类型与MongoId的映射字典
//     /// </summary>
//     public static readonly Dictionary<string, MongoId> TypesDict = new Dictionary<string, MongoId>
//     {
